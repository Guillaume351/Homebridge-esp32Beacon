 ...
 */
export class EspSwitchPlatformAccessory {
  ...
  constructor(
    ...
    this.service.setCharacteristic(BeaconPlatform.Characteristic.Name, 'esp32beacon');
  ...
  async setOn(value: CharacteristicValue) {
    ...
    this.esp32SwitchStates.On = !this.esp32SwitchStates.On;//value as boolean;
  ...
  async getOn(): Promise<CharacteristicValue> {
    ...
    const isOn = this.esp32SwitchStates.On;
